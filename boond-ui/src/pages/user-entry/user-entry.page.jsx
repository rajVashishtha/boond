    ...
    render() {
        return (
            <div className={"admin-entry"}>
                <h2 align={"center"}>Users Entry Page</h2>
                ...
                <SignUp root={{ marginLeft:"auto",marginRight:"auto", width:"500px"}} display={"user"}/>
                <SignIn root={{marginLeft:"auto",marginRight:"auto", width:"500px"}} display={"user"}/>
                </SwipeableViews>
            </div>
        );
    }
